...
export const PERMIT_NEGATIVE_RE = /denied|revoked|suspend|reject|pending|nots+(?:issu|approv|releas|grant|clear|accept|yet|ins)|held|withdraw|expired|return/i;
